...
% I added only a very marginal change for the tight to include the tex names and the x-axis in the plots 
...
%         fsize = cell2mat(get(hax, 'FontSize'));
        ti = cell2mat(get(hax,'TightInset')) + 0.2;
